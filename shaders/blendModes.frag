...
vec3 reflectt(vec3 target, vec3 blend) {
    return (target * target) / (1.0 - blend);
}
...
void main() {
    ...
    else if (blendMode== 18) finalImage = reflectt(upperTexture, lowerTexture);
